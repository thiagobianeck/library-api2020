...
public class BookControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar ResourceNotFound quando o livro procurado não existir.")
    ...
    @Test
    @DisplayName("Deve retornar ResourceNotFound quando não encontrar o livro para deletar.")
